...
- v0.1.0-alpha の experimental 表現から、現在の mainline における文書化された選択 workflow 向け `workflow-compatible` サポートへの adapter maturity 進行を文書化。`provider-compatible` parity は claim しない。
