...
| OpenAI-compatible API | `openai` | `/openai` | `workflow-compatible` | models, chat completions including Chat Completions streaming, embeddings, … ([spec](docs/adapters/openai.md)) |
